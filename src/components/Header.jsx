...
export default function Header(props) {
  ...
  return (
    <header className="fixed h-12 w-full bg-custom-dark-translucent backdrop-blur z-50">
      <div className="flex justify-between items-center p-2 mx-auto max-w-3xl gap-4">
